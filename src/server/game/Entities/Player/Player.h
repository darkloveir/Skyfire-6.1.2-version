...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOAD_AURA_EFFECTS            = 4,
    PLAYER_LOGIN_QUERY_LOAD_SPELLS                  = 5,
    PLAYER_LOGIN_QUERY_LOAD_QUEST_STATUS            = 6,
    PLAYER_LOGIN_QUERY_LOAD_QUEST_OBJECTIVE_STATUS  = 7,
    ...
    PLAYER_LOGIN_QUERY_LOAD_HOME_BIND               = 15,
    PLAYER_LOGIN_QUERY_LOAD_SPELL_COOLDOWNS         = 16,
    PLAYER_LOGIN_QUERY_LOAD_SPELL_CHARGES           = 17,
    PLAYER_LOGIN_QUERY_LOAD_DECLINED_NAMES          = 18,
    PLAYER_LOGIN_QUERY_LOAD_GUILD                   = 19,
    PLAYER_LOGIN_QUERY_LOAD_ARENA_INFO              = 20,
    PLAYER_LOGIN_QUERY_LOAD_ACHIEVEMENTS            = 21,
    PLAYER_LOGIN_QUERY_LOAD_CRITERIA_PROGRESS       = 22,
    PLAYER_LOGIN_QUERY_LOAD_EQUIPMENT_SETS          = 23,
    PLAYER_LOGIN_QUERY_LOAD_BG_DATA                 = 24,
    PLAYER_LOGIN_QUERY_LOAD_GLYPHS                  = 25,
    PLAYER_LOGIN_QUERY_LOAD_TALENTS                 = 26,
    PLAYER_LOGIN_QUERY_LOAD_ACCOUNT_DATA            = 27,
    PLAYER_LOGIN_QUERY_LOAD_SKILLS                  = 28,
    PLAYER_LOGIN_QUERY_LOAD_WEEKLY_QUEST_STATUS     = 29,
    PLAYER_LOGIN_QUERY_LOAD_RANDOM_BG               = 30,
    PLAYER_LOGIN_QUERY_LOAD_BANNED                  = 31,
    PLAYER_LOGIN_QUERY_LOAD_QUEST_STATUS_REW        = 32,
    PLAYER_LOGIN_QUERY_LOAD_INSTANCE_LOCK_TIMES     = 33,
    PLAYER_LOGIN_QUERY_LOAD_SEASONAL_QUEST_STATUS   = 34,
    PLAYER_LOGIN_QUERY_LOAD_MONTHLY_QUEST_STATUS    = 35,
    PLAYER_LOGIN_QUERY_LOAD_VOID_STORAGE            = 36,
    PLAYER_LOGIN_QUERY_LOAD_CURRENCY                = 37,
    PLAYER_LOGIN_QUERY_LOAD_CUF_PROFILES            = 38,
    PLAYER_LOGIN_QUERY_LOAD_BATTLE_PETS             = 39,
    PLAYER_LOGIN_QUERY_LOAD_BATTLE_PET_SLOTS        = 40,
