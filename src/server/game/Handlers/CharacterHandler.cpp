...
void WorldSession::HandleCharCreateOpcode(WorldPacket& recvData)
{
    ...
    uint8 HasTemplate = recvData.ReadBit();
...
void WorldSession::HandlePlayerLogin(LoginQueryHolder* holder)
{
    ...
    data.WriteBit(0);                   // Tutorial
    data.WriteBit(0);                   // bit90
    data.WriteBit(0);                   // Twitter
    data.WriteBit(0);                   // CommerceSystem
    data.WriteBit(0);                   // bit67
    data.WriteBit(0);                   // WillKickFromWorld
    data.WriteBit(0);                   // bit61
    data.FlushBits();
